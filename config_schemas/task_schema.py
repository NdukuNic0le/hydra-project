...
@dataclass
class MNISTClassificationTrainingTask(TaskConfig):
...
def setup_config() -> None:
    ...
    cs.store(group= "task",  name="mnist_classification_trainig_task_schema", node=MNISTClassificationTrainingTask)